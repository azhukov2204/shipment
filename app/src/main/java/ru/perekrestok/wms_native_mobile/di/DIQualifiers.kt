package ru.perekrestok.wms_native_mobile.di
...
object DIQualifiers {
    ...
    fun navigationHolderQualifier(moduleQualifier: String) =
        qualifier(moduleQualifier, FORMAT_NAVIGATION_HOLDER)

    fun routerQualifier(moduleQualifier: String) = qualifier(moduleQualifier, FORMAT_ROUTER)

    private fun qualifier(moduleQualifier: String, format: String) =
        named("${moduleQualifier}_$format")
}
